...
# Useful if shadow prices are required
...
# - sp : Binary, to indicate if shadow prices are going to be generated - NOT RECOMMENDED FOR MULTIOBJECTIVE OPTIMIZATION setting
         ...
         #   z_values = value.(z)
          #  for i in 1:t_size
           #     fix(z[i], z_values[i]; force=true)
            ...
            # Minimize EDB to expnad capacity in countries
...
#runOptimization(demandBase,deposittest,"Base",0.1,false)
...
#runOptimization(demand_scen,deposit,"ParameterCheck/Deposit_SCCost_2k",0.1,false)
#deposit = DataFrame(CSV.File("Parameters/Deposit_SCCost_3k.csv"))
#runOptimization(demand_scen,deposit,"ParameterCheck/Deposit_SCCost_3k",0.1,false)
#deposit = DataFrame(CSV.File("Parameters/Deposit_LCEPrice_15k.csv"))
#runOptimization(demand_scen,deposit,"ParameterCheck/Deposit_LCEPrice_15k",0.1,false)
#deposit = DataFrame(CSV.File("Parameters/Deposit_LCEPrice_30k.csv"))
