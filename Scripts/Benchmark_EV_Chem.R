...
# Load data --------------
df <- read_excel("Data/Lithium-ion-Battery-Database-Q2-2023-1.xlsx",
...
write.csv(evVol,"Results/Battery/Chemistry_Scenarios/bat_share_2050_world.csv",row.names = F)
...
write.csv(evVol_LFP,"Results/Battery/Chemistry_Scenarios/LFP_scen_world.csv",row.names = F)
...
write.csv(evVol_LFP,"Results/Battery/Chemistry_Scenarios/LFP_scen_region.csv",row.names = F)
...
write.csv(evVol_NMC,"Results/Battery/Chemistry_Scenarios/NMC811_scen_world.csv",row.names = F)
...
write.csv(evVol_NMC,"Results/Battery/Chemistry_Scenarios/NMC811_scen_region.csv",row.names = F)
